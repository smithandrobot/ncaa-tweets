...
function ScheduleController(){function $getFeedsForRound$$($r_round$$){var $dates_feed$$=$getRoundDates$$($r_round$$);$r_round$$=[$dates_feed$$.start.clone()];for($feedURLs$$=[];$dates_feed$$.start<$dates_feed$$.end;){$dates_feed$$.start.add({days:1});var $d$$=$dates_feed$$.start.clone();$r_round$$.push($d$$)}for($d$$ in $r_round$$){$dates_feed$$="events-"+$r_round$$[$d$$].toString("yyyyMMdd")+".json";$feedURLs$$.push($dates_feed$$)}}function $getGamesForRound$$($game$$1_round$$){var $eligibleGames$$=
...
"INTERMISSION"){$templateData$$.game.status="current";$templateData$$.game.period="Half"}else{$templateData$$.game.status="current";$templateData$$.game.period=Utils.ordinal($data$$.eventstatus.curPeriod)}$self$$.active=true}return $self$$.templateData=$templateData$$}function $teamClick$$($obj$$){$self$$.selected=$obj$$.data.teamId;dispatchEvent("onTeamSelect",$self$$)}function $hashTagClick$$(){$self$$.hashTag="Go "+$(this).text()+"!";dispatchEvent("onHashTagClick",$self$$);return false}var $self$$=
this;$self$$.update=function update($data$$22_viewData$$){$data$$22_viewData$$=$sanitizeData$$($data$$22_viewData$$);$self$$.visitorScore.text($data$$22_viewData$$.visitingTeam.score);$self$$.homeScore.text($data$$22_viewData$$.homeTeam.score);$self$$.period.text($data$$22_viewData$$.game.period);$self$$.view.data($data$$22_viewData$$);$visualizeWL$$();$data$$22_viewData$$.game.status=="final"&&$self$$.view.addClass("game-final")};$self$$.setTeamModel=function setTeamModel($model$$){$self$$.teams=
