...
function TwitterProxy(){var $twitterOBJ$$=null,$self$$=this;this.isConnected=function isConnected(){Log("self.twitterOBJ: isConnected");return $twitterOBJ$$.isConnected()};this.twitterOBJ=null;this.getTweetBox=function getTweetBox($id$$,$obj$$){$twitterOBJ$$($id$$).tweetBox($obj$$)};twttr.anywhere(function init($t$$){$twitterOBJ$$=$t$$;$self$$.twitterOBJ=$t$$;dispatchEvent("onReady",$self$$)});return this}ModalOverlay.prototype=new EventDispatcher;ModalOverlay.constructor=ModalOverlay;
...
function ModalFollow($overlay$$){function $onClose$$(){$element$$.fadeOut(250);$overlay$$.close();$state$$="closed"}function $position$$($animate$$3_top$$){var $docY$$=$(window).height()/2-100,$docX$$=$(document).width()/2,$height$$=$element$$.height()/2,$width$$=$element$$.width()/2,$propObject$$={};$propObject$$.left=$docX$$-$width$$;$propObject$$.top=$docY$$-$height$$<0?10:$docY$$-$height$$;$animate$$3_top$$?$element$$.animate($propObject$$,250):$element$$.css($propObject$$)}function $onFollow$$(){var $cs$$inline_105_t$$12_validUser$$=
false,$t$$=$self$$.twitterProxy.twitterOBJ;if($t$$.isConnected())$cs$$inline_105_t$$12_validUser$$=true;else{$t$$.bind("authComplete",$onFollow$$);$t$$.signIn()}if($cs$$inline_105_t$$12_validUser$$){$cs$$inline_105_t$$12_validUser$$=$self$$.twitterProxy.twitterOBJ;Log("follow user: "+$user$$);$cs$$inline_105_t$$12_validUser$$.User.find($user$$).follow();$cs$$inline_105_t$$12_validUser$$=$element$$.find(".confirmation-screen");$element$$.find(".action-screen").hide();$cs$$inline_105_t$$12_validUser$$.show()}}
var $element$$=$("#modal-follow-template"),$state$$="closed",$user$$=null,$self$$=this;this.tweet=this.tweetProxy=null;this.open=function open($cs$$inline_112_tweet$$){if($cs$$inline_112_tweet$$){$cs$$inline_112_tweet$$.getElement().clone();$element$$.find(".modal-dialog").append().html('Start following<br /><span class="red">'+$cs$$inline_112_tweet$$.screenName+"</span>");$element$$.find(".confirmation").append().html('You are now following<br /><span class="red">'+$cs$$inline_112_tweet$$.screenName+
"</span>")}$user$$=$cs$$inline_112_tweet$$.screenName;Log("follow user: "+$user$$);if($state$$=="closed"){$cs$$inline_112_tweet$$=$element$$.find(".confirmation-screen");var $as$$=$element$$.find(".action-screen");$cs$$inline_112_tweet$$.hide();$as$$.show();$element$$.css("z-index",$overlay$$.z+1);$element$$.fadeIn(250);$overlay$$.open()}$position$$();$state$$="open"};$overlay$$.addEventListener("onModalOverlayClose",$onClose$$);(function decorateBTNS(){var $cBtn$$4_cancelBtn$$3_fBtn_okBtn$$=$element$$.find(".close-button");
$cBtn$$4_cancelBtn$$3_fBtn_okBtn$$.click($onClose$$);$cBtn$$4_cancelBtn$$3_fBtn_okBtn$$.hover(function(){$(this).css("cursor","pointer")},function(){$(this).css("cursor","auto")});$cBtn$$4_cancelBtn$$3_fBtn_okBtn$$=$element$$.find(".modal-cancel-button");$cBtn$$4_cancelBtn$$3_fBtn_okBtn$$.click($onClose$$);$cBtn$$4_cancelBtn$$3_fBtn_okBtn$$.hover(function(){$(this).css("cursor","pointer")},function(){$(this).css("cursor","auto")});$cBtn$$4_cancelBtn$$3_fBtn_okBtn$$=$element$$.find(".modal-follow-button");
$cBtn$$4_cancelBtn$$3_fBtn_okBtn$$.click($onFollow$$);$cBtn$$4_cancelBtn$$3_fBtn_okBtn$$.hover(function(){$(this).css("cursor","pointer")},function(){$(this).css("cursor","auto")});$cBtn$$4_cancelBtn$$3_fBtn_okBtn$$=$element$$.find(".modal-confirm-button");$cBtn$$4_cancelBtn$$3_fBtn_okBtn$$.click($onClose$$);$cBtn$$4_cancelBtn$$3_fBtn_okBtn$$.hover(function(){$(this).css("cursor","pointer")},function(){$(this).css("cursor","auto")})})();$element$$.css("position","fixed");$position$$(false);return this}
FavoriteModal.prototype=new EventDispatcher;FavoriteModal.constructor=FavoriteModal;
...
var $cs$$inline_124_validUser$$=false,$t$$=$self$$.twitterProxy.twitterOBJ;if($t$$.isConnected())$cs$$inline_124_validUser$$=true;else{$t$$.bind("authComplete",$onFavorite$$);$t$$.signIn()}if($cs$$inline_124_validUser$$){$self$$.twitterProxy.twitterOBJ.Status.favorite($tweetID$$);$cs$$inline_124_validUser$$=$element$$.find(".confirmation-screen");$element$$.find(".action-screen").hide();$cs$$inline_124_validUser$$.show()}else Log("user did not validate, authorizing...")}var $element$$=$("#modal-favorite-template"),
$state$$="closed",$tweetID$$=null,$self$$=this;this.tweet=null;this.open=function open($cs$$inline_131_tweet$$){if($cs$$inline_131_tweet$$){$cs$$inline_131_tweet$$.getElement().clone();$element$$.find(".modal-dialog").append().html('Favorite this tweet from<br /><span class="red">'+$cs$$inline_131_tweet$$.screenName+"</span>")}$tweetID$$=$cs$$inline_131_tweet$$.tweetID;if($state$$=="closed"){$cs$$inline_131_tweet$$=$element$$.find(".confirmation-screen");var $as$$=$element$$.find(".action-screen");
$cs$$inline_131_tweet$$.hide();$as$$.show();$element$$.css("z-index",$overlay$$.z+1);$element$$.fadeIn(250);$overlay$$.open()}$position$$();$state$$="open"};this.twitterProxy=null;$overlay$$.addEventListener("onModalOverlayClose",$onClose$$);(function decorateBTNS(){var $cBtn$$5_cancelBtn$$4_fvtBtn_okBtn$$=$element$$.find(".close-button");$cBtn$$5_cancelBtn$$4_fvtBtn_okBtn$$.click($onClose$$);$cBtn$$5_cancelBtn$$4_fvtBtn_okBtn$$.hover(function(){$(this).css("cursor","pointer")},function(){$(this).css("cursor",
"auto")});$cBtn$$5_cancelBtn$$4_fvtBtn_okBtn$$=$element$$.find(".modal-cancel-button");$cBtn$$5_cancelBtn$$4_fvtBtn_okBtn$$.click($onClose$$);$cBtn$$5_cancelBtn$$4_fvtBtn_okBtn$$.hover(function(){$(this).css("cursor","pointer")},function(){$(this).css("cursor","auto")});$cBtn$$5_cancelBtn$$4_fvtBtn_okBtn$$=$element$$.find(".modal-confirm-button");$cBtn$$5_cancelBtn$$4_fvtBtn_okBtn$$.click($onClose$$);$cBtn$$5_cancelBtn$$4_fvtBtn_okBtn$$.hover(function(){$(this).css("cursor","pointer")},function(){$(this).css("cursor",
"auto")});$cBtn$$5_cancelBtn$$4_fvtBtn_okBtn$$=$element$$.find(".modal-favorite-button");$cBtn$$5_cancelBtn$$4_fvtBtn_okBtn$$.click($onFavorite$$);$cBtn$$5_cancelBtn$$4_fvtBtn_okBtn$$.hover(function(){$(this).css("cursor","pointer")},function(){$(this).css("cursor","auto")})})();$element$$.css("position","fixed");$position$$(false);return this}TRModel.prototype=new EventDispatcher;TRModel.constructor=TRModel;TRModel.constructor.id=0;
function TRModel($URL$$){function $onStreamError$$(){++$attempt$$;if($attempt$$!=$maxAttempts$$){Log("unable to load stream attempt: "+$attempt$$);dispatchEvent("onModelError",$self$$);setTimeout($loadCallback$$,$attemptInterval$$)}}function $onStreamLoaded$$($d$$){$data$$=$d$$;dispatchEvent("onDataChange",$self$$)}function $loadCustomCallBack$$($sinceID$$,$callback$$){var $aObj_since$$={},$callbackName$$="trCallback_"+String($self$$.id)+"_x";$loadCallback$$=$loadCustomCallBack$$;window[$callbackName$$]=
$self$$.trCallback;$aObj_since$$.url=$stream$$+($sinceID$$?"?since_id="+$sinceID$$:"");if($callback$$)$aObj_since$$.jsonp=$callback$$;$aObj_since$$.cache=true;$aObj_since$$.dataType="jsonp";$aObj_since$$.success=$onStreamLoaded$$;$aObj_since$$.error=$onStreamError$$;$aObj_since$$.jsonpCallback=$callbackName$$;$.ajax($aObj_since$$)}function $loadJSON$$(){$loadCallback$$=$loadJSON$$;var $aObj$$={};$aObj$$.url=$stream$$;$aObj$$.cache=false;$aObj$$.dataType="json";$aObj$$.success=$onStreamLoaded$$;$aObj$$.error=
$onStreamError$$;$.ajax($aObj$$)}var $self$$=this,$stream$$=$URL$$,$data$$,$type$$,$maxAttempts$$=5,$attempt$$=0,$attemptInterval$$=1E3,$loadCallback$$;this.name="model";this.id="TR_MODEL_"+ ++TRModel.constructor.id;this.getStream=function $this$getStream$(){return $stream$$};this.setStream=function $this$setStream$($s$$){$stream$$=$s$$};this.getData=function $this$getData$(){return $data$$};this.setType=function $this$setType$($t$$){$type$$=$t$$};this.getType=function $this$getType$(){return $type$$};
this.load=$loadCustomCallBack$$;this.loadJSON=$loadJSON$$;this.toString=function $this$toString$(){return"TRModel: "+this.id};this.poll=function poll($sinceID$$){$loadCustomCallBack$$($sinceID$$)};this.trCallback=function trCallback(){};return this}TeamsModel.prototype=new EventDispatcher;TeamsModel.constructor=TeamsModel;
function TeamsModel(){function $poll$$(){$model$$.load(null,"jsonp")}var $self$$=this,$model$$=new TRModel;$model$$.addEventListener("onDataChange",function onDataChange($data$$15_e$$){$data$$15_e$$=$data$$15_e$$.target.getData();if($teamsLoaded$$)for($s$$ in $data$$15_e$$.streams){$stream$$=$data$$15_e$$.streams[$s$$];$breaks_team$$=$stream$$.name.split("-");if($breaks_team$$.length==3){var $breaks_team$$=$self$$.team_schema[$breaks_team$$[2]];if($breaks_team$$)$breaks_team$$.mentions=$stream$$.count.total}}else{for(var $s$$ in $data$$15_e$$.streams){var $stream$$=
$data$$15_e$$.streams[$s$$];$breaks_team$$=$stream$$.name.split("-");if($breaks_team$$.length==3){var $teamData$$=$stream$$.description.split("|");$self$$.team_schema[$breaks_team$$[2]]={seed:$.trim($teamData$$[0]),displayName:$.trim($teamData$$[1]),hashTag:$.trim($teamData$$[2]),shortName:$breaks_team$$[2],stream:$stream$$.full_name+"-curated",mentions:$stream$$.count.total}}}$teamsLoaded$$=true}dispatchEvent("onTeamModelReady",$self$$);clearInterval($self$$.interval);$self$$.interval=setInterval($poll$$,
$INTERVAL_TIME$$)});var $INTERVAL_TIME$$=5E3,$teamsLoaded$$=false;this.getTeam=function getTeam($id$$){$id$$=$id$$.toLowerCase();return $self$$.team_schema[$id$$]};this.getAll=function getAll(){return $self$$.team_schema};this.setTeamColor=function setTeamColor($id$$,$color$$){$id$$=$id$$.toLowerCase();$self$$.team_schema[$id$$].color=$color$$};Log("Fetching team data");$self$$.team_schema={};$model$$.setStream("http://tweetriver.com/mr_mm_2011.json");$model$$.load(null,"jsonp");return $self$$}
Tweet.prototype=new EventDispatcher;Tweet.constructor=Tweet;
function Tweet(){function $decorateImg$$(){var $photo$$=$element$$.find(".tweet-attachment");$photo$$.click($onPhotoClick$$);$photo$$.hover(function(){$(this).css("cursor","pointer")},function(){$(this).css("cursor","auto")})}function $onClickReply$$(){dispatchEvent("onReply",$self$$)}function $onClickFollow$$(){dispatchEvent("onFollow",$self$$)}function $onClickReTweet$$(){Log("onClickReTweet");dispatchEvent("onReTweet",$self$$)}function $onClickFavorite$$(){var $type$$=$(this).text();Log("type: "+
$type$$);$type$$=="Favorite"&&$(this).find("b").text("Unfavorite");$type$$=="Unfavorite"&&$(this).find("b").text("Favorite");dispatchEvent("onFavorite",$self$$)}function $onPhotoClick$$(){Log("image: "+$self$$.largeImage);dispatchEvent("onPhotoClick",$self$$)}function $decorate$$($e$$){$e$$.find(".action-follow").click($onClickFollow$$);$e$$.find(".action-favorite").click($onClickFavorite$$);$e$$.find(".action-retweet").click($onClickReTweet$$);$e$$.find(".action-reply").click($onClickReply$$);$e$$.find(".tweet-utility").fadeTo("fast",
0.5);$e$$.hover(function(){$(this).find(".tweet-utility").stop().fadeTo("slow",1)},function(){$(this).find(".tweet-utility").stop().fadeTo("slow",0.5)})}function $parseDate$$(){var $t$$=TimeStamp.timeSince($self$$.timeStamp);if($t$$.days>0)return $t$$.days+" "+($t$$.days==1?"day":"days")+" ago";if($t$$.hours>0)return $t$$.hours+" "+($t$$.hours==1?"hour":"hours")+" ago";if($t$$.minutes>0)return $t$$.minutes+" "+($t$$.minutes==1?"minute":"minutes")+" ago";if($t$$.seconds<1)return"less than a second ago";
return $t$$.seconds+" "+($t$$.seconds==1?"second":"seconds")+" ago"}var $self$$=this,$element$$=null,$profileImg$$,$mediaParser$$=new MediaParser;this.type=null;this.setData=function setData($d$$){$self$$.tweetText=$d$$.text;$self$$.htmlText=TweetParser.parse($d$$.text);$self$$.tweetID=$d$$.id_str;$self$$.timeStamp=$d$$.created_at;$self$$.time=$parseDate$$();$self$$.screenName=$d$$.user.screen_name;$self$$.userName=$d$$.user.name;$self$$.bio=$d$$.user.description;$self$$.followers=$d$$.user.followers_count;
$self$$.following=$d$$.user.friends_count;$self$$.tweets=$d$$.user.statuses_count;$self$$.orderID=$d$$.order_id;$profileImg$$=$d$$.user.profile_image_url};this.getHTML=function getHTML(){$element$$=$(Tweet.constructor.tweetTemplate);$element$$.attr("id","tweet-"+$self$$.tweetID+"-"+(new Date).getTime());$element$$.find(".tweet-timestamp a").text($self$$.time);$element$$.find(".tweet-timestamp a").attr("href","http://www.twitter.com/#!/"+$self$$.screenName+"/status/"+$self$$.tweetID);$element$$.find(".tweet-name a").attr("href",
"http://www.twitter.com/#!/"+$self$$.screenName);$element$$.find(".tweet-name a").attr("title",$self$$.userName);$element$$.find(".tweet-name-full").text($self$$.userName);$element$$.find(".tweet-name a").text($self$$.screenName);$element$$.find(".tweet-profile-image a").attr("href","http://www.twitter.com/#!/"+$self$$.screenName);$element$$.find(".tweet-profile-image a img").attr("src",$profileImg$$);$element$$.find(".tweet-profile-image a img").attr("width",48);$element$$.find(".tweet-profile-image a img").attr("height",
48);$element$$.find(".tweet-text").html($self$$.htmlText);$mediaParser$$.getImage($self$$.tweetText)||$element$$.find(".tweet-attachment").remove();$decorate$$($element$$);return $element$$};this.remove=function remove(){$element$$.remove()};this.updateTime=function updateTime(){$self$$.time=$parseDate$$();$element$$.find(".tweet-timestamp a").text($self$$.time)};this.getElement=function $this$getElement$(){return $element$$};$mediaParser$$.addEventListener("onImageData",function onImageData($e$$){var $thumb$$=
new Image;$thumb$$.onload=$decorateImg$$;$thumb$$.src=$e$$.target.thumb;$self$$.largeImage=$e$$.target.largeImage;$element$$.find(".tweet-attachment").css("background-image","url("+$thumb$$.src+")")});return this}$(document).ready(function(){new Application});
...
function TweetListController(){function $selectTeam$$($nameElement$$inline_146_t$$inline_139_team$$){clearInterval($autoStartInt$$);Log("team selected! "+$nameElement$$inline_146_t$$inline_139_team$$);var $obj$$=$nameElement$$inline_146_t$$inline_139_team$$.team,$name$$=$nameElement$$inline_146_t$$inline_139_team$$.team.displayName?$nameElement$$inline_146_t$$inline_139_team$$.team.displayName:$obj$$.name,$hState_orgSize$$=$name$$.indexOf("ALL TEAMS")==-1?"show":"hide",$f$$="http://tweetriver.com/mr_mm_2011/mm-2011-"+
$obj$$.shortName+".json";$feedColor$$=$obj$$.color;$setFeed$$($f$$);$updateColors$$();$nameElement$$inline_146_t$$inline_139_team$$=$nameElement$$inline_146_t$$inline_139_team$$.team.hashTag;if($hState_orgSize$$=="show"){$(".spirit-bubble").text("go "+$nameElement$$inline_146_t$$inline_139_team$$);$("#team-selector").hide();$(".spirit-bubble").show();$("#show-all-streams").show()}else{$(".spirit-bubble").hide();$("#team-selector").show();$("#show-all-streams").hide()}$hState_orgSize$$=25;$nameElement$$inline_146_t$$inline_139_team$$=
$("#stream-header h2");$nameElement$$inline_146_t$$inline_139_team$$.css("font-size",$hState_orgSize$$);$nameElement$$inline_146_t$$inline_139_team$$.text($name$$);for(Log("name width: "+$nameElement$$inline_146_t$$inline_139_team$$.width());$nameElement$$inline_146_t$$inline_139_team$$.width()>220;){$hState_orgSize$$-=1;$nameElement$$inline_146_t$$inline_139_team$$.css("font-size",$hState_orgSize$$)}}function $setFeed$$($feedURL$$2_i$$){$("#loadmore-count").hide();$removeScrollbar$$();$model$$.setStream($feedURL$$2_i$$);
$updateModel$$.setStream($feedURL$$2_i$$);$model$$.load();if($tweets$$){$feedURL$$2_i$$=0;for(var $total$$=$tweets$$.length-1,$t$$;$feedURL$$2_i$$<=$total$$;$feedURL$$2_i$$++){$t$$=$tweets$$[$feedURL$$2_i$$];$t$$.remove()}}$loader$$.show()}function $poll$$(){$updateModel$$.poll($lastID$$);if($tweets$$)for(var $i$$=0,$total$$=$tweets$$.length-1,$t$$;$i$$<=$total$$;$i$$++){$t$$=$tweets$$[$i$$];$t$$.updateTime()}}function $onReTweet$$($e$$){Log("retweeting");$retweetModal$$.open($e$$.target)}function $onFavorite$$($e$$){Log("favoriting");
$favoriteModal$$.open($e$$.target)}function $onReply$$($e$$){Log("onReply");$replyModal$$.open($e$$.target)}function $onFollow$$($e$$){Log("favoriting");$followModal$$.open($e$$.target)}function $onPhotoClick$$($e$$){$photoModal$$.open($e$$.target)}function $addListeners$$($t$$){$t$$.addEventListener("onReTweet",$onReTweet$$);$t$$.addEventListener("onFavorite",$onFavorite$$);$t$$.addEventListener("onReply",$onReply$$);$t$$.addEventListener("onFollow",$onFollow$$);$t$$.addEventListener("onPhotoClick",
$onPhotoClick$$)}function $updateColors$$(){$(".team-tweets-css-scrollbar .scrollbar-handle").css("background-color",$feedColor$$);$("#timeline .tweet-bg a").not("#timeline .tweet-bg .tweet-utility a").css("color",$feedColor$$);$(".spirit-bubble").css("background-color",$feedColor$$);$("#loadmore a").css("background-color",$feedColor$$);$("#stream-header h2").css("color",$feedColor$$)}function $addScrollbar$$(){$(".team-tweets-css-scrollbar").scrollbar({handleHeight:60,arrows:false})}function $removeScrollbar$$(){var $l$$=
$("#loadmore").detach(),$t$$=$("#main-timeline").detach();$("#timeline .scrollbar-pane").remove();$("#timeline .scrollbar-handle-container").remove();$("#timeline .scrollbar-handle-up").remove();$("#timeline .scrollbar-handle-down").remove();$("#timeline").prepend($t$$);$("#timeline").prepend($l$$)}var $autoStartInt$$=null,$feedColor$$=null,$tweets$$=null,$newTweets$$=null,$model$$=new TRModel,$updateModel$$=new TRModel,$updateInt$$=null,$loader$$=$("#tweet-team-loader"),$element$$=$("#main-timeline"),
$lastID$$,$verizonModule$$=new VerizonModule,$modalOverlay$$=new ModalOverlay,$retweetModal$$=new ReTweetModal($modalOverlay$$),$favoriteModal$$=new FavoriteModal($modalOverlay$$),$replyModal$$=new ModalReply($modalOverlay$$),$followModal$$=new ModalFollow($modalOverlay$$),$photoModal$$=new ModalPhoto($modalOverlay$$),$modalTweetBox$$=new ModalTweetBox($modalOverlay$$),$twitterProxy$$=new TwitterProxy;$twitterProxy$$.addEventListener("onReady",$verizonModule$$.twitterReady);$favoriteModal$$.twitterProxy=
$twitterProxy$$;$modalOverlay$$.twitterProxy=$twitterProxy$$;$retweetModal$$.twitterProxy=$twitterProxy$$;$favoriteModal$$.twitterProxy=$twitterProxy$$;$replyModal$$.twitterProxy=$twitterProxy$$;$followModal$$.twitterProxy=$twitterProxy$$;$photoModal$$.twitterProxy=$twitterProxy$$;$modalTweetBox$$.twitterProxy=$twitterProxy$$;$verizonModule$$.twitterProxy=$twitterProxy$$;this.setFeed=$setFeed$$;this.selectTeam=$selectTeam$$;this.hashTagClick=function hashTagClick($h$$){Log("list controller got hashtag: "+
$h$$);$modalTweetBox$$.open($h$$)};this.toString=function toString(){return"TweetListController"};$addListeners$$($verizonModule$$);$model$$.addEventListener("onDataChange",function onDataChange($data$$inline_168_e$$){$loader$$.hide();$data$$inline_168_e$$=$data$$inline_168_e$$.target.getData();var $i$$=0,$total$$=$data$$inline_168_e$$.length-1,$t$$=null;$tweets$$=[];$element$$.css("opacity",0);for($("#loadmore-count").hide();$i$$<=$total$$;$i$$++){$t$$=new Tweet;$tweets$$.push($t$$);$addListeners$$($t$$);
$t$$.setData($data$$inline_168_e$$[$i$$]);$element$$.append($t$$.getHTML())}$addScrollbar$$();$updateColors$$();$element$$.animate({opacity:1},500);dispatchEvent("tweetListLoaded",self);$lastID$$=$data$$inline_168_e$$[0].order_id;clearInterval($updateInt$$);$updateInt$$=setTimeout($poll$$,1E4)});$updateModel$$.addEventListener("onDataChange",function onDataUpdate($data$$16_e$$){$data$$16_e$$=$data$$16_e$$.target.getData();var $total$$=$data$$16_e$$.length-1,$i$$=0,$t$$;if($total$$>=0){$("#loadmore-count").text($total$$+
1+" New Tweets");$("#loadmore-count").fadeIn(300);$newTweets$$=[];for($i$$=0;$i$$<=$total$$;$i$$++){$t$$=new Tweet;$t$$.setData($data$$16_e$$[$i$$]);$newTweets$$.push($t$$)}}else $("#loadmore-count").fadeOut(300);clearInterval($updateInt$$);$updateInt$$=setTimeout($poll$$,1E4)});(function enableShowAllTeams(){var $s$$=$("#show-all-streams");$s$$.click(function(){$selectTeam$$({team:{displayName:"ALL TEAMS",shortName:"all",name:"ALL TEAMS",color:"#ED1F24"}})});$s$$.hover(function(){$(this).css("cursor",
...
$data$$18_e$$.target.getData();$self$$.scheduleData=$data$$18_e$$.events.event;$data$$18_e$$=$getGamesForRound$$($self$$.loadedRound);if($streamLoadCount$$>0){$streamLoadCount$$--;$("#scoreboard-loader").hide();$($data$$18_e$$).each(function(){var $data$$inline_176_game$$=$(this)[0];$data$$inline_176_game$$=new GameController($data$$inline_176_game$$,$self$$.teams);$games$$.push($data$$inline_176_game$$);$data$$inline_176_game$$.addEventListener("onTeamSelect",$teamClick$$);$data$$inline_176_game$$.addEventListener("onHashTagClick",
$onHashTagClick$$);if($data$$inline_176_game$$.active&&$self$$.firstActive==null)$self$$.firstActive=$data$$inline_176_game$$});$self$$.firstActive&&$self$$.firstActive.view.position();if($streamLoadCount$$==0){$sortGames$$();$(".schedule-scrollbar").scrollbar({handleHeight:151,arrows:false})}}else $($data$$18_e$$).each(function(){var $data$$=$(this)[0];for(game in $games$$)$games$$[game].id==$data$$.id&&$games$$[game].update($data$$)})});$self$$.loadRound=function loadRound($round$$){$getFeedsForRound$$($round$$);
...
$compareMentions$$();return $template$$}function $compareMentions$$(){if($self$$.homeTeam.customData.mentions>$self$$.visitingTeam.customData.mentions){$self$$.homeMentions.addClass("team-mentions-large");$self$$.homeMentions.removeClass("team-mentions-small")}else if($self$$.homeTeam.customData.mentions<$self$$.visitingTeam.customData.mentions){$self$$.visitorMentions.addClass("team-mentions-large");$self$$.visitorMentions.removeClass("team-mentions-small")}}function $sanitizeData$$($data$$){var $templateData$$=
{game:{id:$data$$.id}};$templateData$$.date=Date.parse($data$$.date);$self$$.date=$templateData$$.date;for(cid in $data$$.competitor){var $c$$=$data$$.competitor[cid];if($c$$.homeaway=="home"){$templateData$$.homeTeam=$c$$;$self$$.homeTeam=$c$$}else{$templateData$$.visitingTeam=$c$$;$self$$.visitingTeam=$c$$}$c$$.customData=$self$$.teams.getTeam($c$$.shortName);if($c$$.customData==undefined){$c$$.customData={};$c$$.customData.hashTag="#team";$c$$.hashTag="#team";$c$$.customData.mentions=0;$c$$.name=
$c$$.shortName}else{$c$$.name=$c$$.customData.displayName;$c$$.hashTag=$c$$.customData.hashTag;$self$$.teams.setTeamColor($c$$.shortName,$c$$.color)}if($c$$.name.length>22)$c$$.name=$c$$.shortName}if($data$$.eventstatus.status=="FINAL"){$templateData$$.game.status="final";$templateData$$.game.period="final";$self$$.active=false}else if($data$$.eventstatus.status=="SCHEDULED"){$templateData$$.game.status="current";$templateData$$.game.period=$templateData$$.date.toString("M/d");$self$$.active=false}else{if($data$$.eventstatus.status==
...
this;$self$$.update=function update($data$$22_viewData$$){$data$$22_viewData$$=$sanitizeData$$($data$$22_viewData$$);$self$$.visitorScore.text($data$$22_viewData$$.visitingTeam.score);$self$$.homeScore.text($data$$22_viewData$$.homeTeam.score);$self$$.period.text($data$$22_viewData$$.game.period);$self$$.view.data($data$$22_viewData$$);$data$$22_viewData$$.game.status=="final"&&$self$$.view.addClass("game-final")};$self$$.setTeamModel=function setTeamModel($model$$){$self$$.teams=$model$$};(function init($data$$,
$model$$){$self$$.id=$data$$.id;$self$$.teams=$model$$;$model$$.addEventListener("onTeamModelReady",$onTeamUpdate$$);var $viewData$$=$sanitizeData$$($data$$);$self$$.view=$createView$$($viewData$$)})($gameData$$,$model$$0$$);return $self$$}NavController.prototype=new EventDispatcher;NavController.constructor=NavController;
...
function TeamSelectorController(){function $activateLinks$$(){$(".team-column a").each(function(){$(this).click(function(){var $teamlist$$=$self$$.teams.getAll(),$tid$$=$(this).attr("id");$self$$.selected={team:$teamlist$$[$tid$$]};$.cookie("team",$tid$$,{expires:30,path:"/"});dispatchEvent("onTeamSelect",$self$$);return false})})}var $self$$=this;$self$$.buildList=function buildList($cTeam$$inline_192_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_193_teams$$){$self$$.teams=$cTeam$$inline_192_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_193_teams$$;
$cTeam$$inline_192_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_193_teams$$=[];var $teamlist$$1_tid$$=$self$$.teams.getAll();for(t in $teamlist$$1_tid$$)$cTeam$$inline_192_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_193_teams$$.push({shortName:$teamlist$$1_tid$$[t].shortName,name:$teamlist$$1_tid$$[t].displayName});$.template("columns",'{{each columns}}<ul class="team-column">{{each $value}}<li><a href="#" id="${$value.shortName}">${$value.name}</a></li>{{/each}}</ul>{{/each}}');
$cTeam$$inline_192_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_193_teams$$=[$cTeam$$inline_192_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_193_teams$$.splice(0,10),$cTeam$$inline_192_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_193_teams$$.splice(0,10),$cTeam$$inline_192_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_193_teams$$.splice(0,10),$cTeam$$inline_192_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_193_teams$$.splice(0,
10),$cTeam$$inline_192_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_193_teams$$.splice(0,13),$cTeam$$inline_192_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_193_teams$$.splice(0,13)];$cTeam$$inline_192_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_193_teams$$=$.tmpl("columns",{columns:$cTeam$$inline_192_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_193_teams$$});$("#team-selector a").qtip({content:$cTeam$$inline_192_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_193_teams$$,
show:"mouseover",hide:{fixed:true},api:{onRender:$activateLinks$$},style:{tip:"bottomRight",width:700,border:{width:0,radius:5,color:"#fff"}},position:{corner:{target:"topMiddle",tooltip:"bottomRight"}}});$cTeam$$inline_192_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_193_teams$$=null;if($.cookie("team")){$cTeam$$inline_192_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_193_teams$$=$self$$.teams.getAll();$teamlist$$1_tid$$=$.cookie("team");$cTeam$$inline_192_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_193_teams$$=
{team:$cTeam$$inline_192_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_193_teams$$[$teamlist$$1_tid$$]}}if($cTeam$$inline_192_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_193_teams$$){$self$$.selected=$cTeam$$inline_192_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_193_teams$$;dispatchEvent("onTeamSelect",$self$$)}};return $self$$};