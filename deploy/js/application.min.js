...
function parse($str$$7_str$$inline_13_str$$){var $hashArray$$inline_23_linkArray$$=$str$$7_str$$inline_13_str$$.match($httpReg$$);if($hashArray$$inline_23_linkArray$$!=null)for(var $total$$inline_15_total$$=$hashArray$$inline_23_linkArray$$.length-1,$i$$inline_16_i$$=0;$i$$inline_16_i$$<=$total$$inline_15_total$$;$i$$inline_16_i$$++){replaceString="<a href='"+$hashArray$$inline_23_linkArray$$[$i$$inline_16_i$$]+"' target='_blank' rel='nofollow' class='twitter-timeline-link'>"+$hashArray$$inline_23_linkArray$$[$i$$inline_16_i$$]+
"</a>";$str$$7_str$$inline_13_str$$=$str$$7_str$$inline_13_str$$.replace($hashArray$$inline_23_linkArray$$[$i$$inline_16_i$$],replaceString)}$hashArray$$inline_23_linkArray$$=$str$$7_str$$inline_13_str$$.match($hashReg$$);if($hashArray$$inline_23_linkArray$$!=null){$total$$inline_15_total$$=$hashArray$$inline_23_linkArray$$.length-1;for($i$$inline_16_i$$=0;$i$$inline_16_i$$<=$total$$inline_15_total$$;$i$$inline_16_i$$++){replaceString="<a href='http://search.twitter.com/search?q="+$hashArray$$inline_23_linkArray$$[$i$$inline_16_i$$].replace("#",
"%23")+"' target='_blank'>"+$hashArray$$inline_23_linkArray$$[$i$$inline_16_i$$]+"</a>";$str$$7_str$$inline_13_str$$=$str$$7_str$$inline_13_str$$.replace($hashArray$$inline_23_linkArray$$[$i$$inline_16_i$$],replaceString)}}return $str$$7_str$$inline_13_str$$=$parseUser$$($str$$7_str$$inline_13_str$$)};this.swapHash=function swapHash($s$$){$s$$.replace("#","%23");return $s$$};this.parseUser=$parseUser$$;return this}();MediaParser.prototype=new EventDispatcher;MediaParser.constructor=MediaParser;
...
function onDataChange($d$$inline_30_data$$12_e$$){$d$$inline_30_data$$12_e$$=$d$$inline_30_data$$12_e$$.target.getData();if($d$$inline_30_data$$12_e$$.length<=0)$element$$.find(".tweet-text").html("<p>Loading Verizon tweets...</p>");else{$d$$inline_30_data$$12_e$$=$d$$inline_30_data$$12_e$$[0];$self$$.tweetText=$d$$inline_30_data$$12_e$$.text;$self$$.htmlText=TweetParser.parse($d$$inline_30_data$$12_e$$.text);$self$$.tweetID=$d$$inline_30_data$$12_e$$.id_str;$self$$.screenName=$d$$inline_30_data$$12_e$$.user.screen_name;
$self$$.userName=$d$$inline_30_data$$12_e$$.user.name;$element$$.find(".tweet-text").html($self$$.htmlText);$element$$.find(".action-follow").click($onClickFollow$$);$element$$.find(".action-favorite").click($onClickFavorite$$);$element$$.find(".action-retweet").click($onClickReTweet$$);$element$$.find(".action-reply").click($onClickReply$$)}});Log("http://tweetriver.com/mr_mm_2011/mm-2011-verizon.json");$model$$.setStream("http://tweetriver.com/mr_mm_2011/mm-2011-verizon.json");$model$$.load();$questionModel$$.addEventListener("onDataChange",
function onQuestionData($data$$13_e$$){$data$$13_e$$=$data$$13_e$$.target.getData();$("#tbox iframe").contents().find("label").text($data$$13_e$$[0].text);clearInterval($qInterval$$);$qInterval$$=setTimeout($questionModel$$.load,1E3)});$questionModel$$.setStream("http://tweetriver.com/mr_mm_2011/mm-2011-verizon-questions.json");$questionModel$$.load();return this}TwitterProxy.prototype=new EventDispatcher;TwitterProxy.constructor=TwitterProxy;
...
function ReTweetModal($overlay$$){function $onClose$$(){$element$$.fadeOut(250);$overlay$$.close();$state$$="closed"}function $showConfirmScreen$$(){var $cs$$=$element$$.find(".confirmation-screen"),$as$$=$element$$.find(".action-screen");$element$$.find(".error-screen").hide();$as$$.hide();$cs$$.show()}function $showErrorScreen$$(){var $cs$$=$element$$.find(".confirmation-screen"),$as$$=$element$$.find(".action-screen");$element$$.find(".error-screen").show();$as$$.hide();$cs$$.hide()}function $position$$($animate$$1_top$$){var $docY$$=
$(window).height()/2-100,$docX$$=$(document).width()/2,$height$$=$element$$.height()/2,$width$$=$element$$.width()/2,$propObject$$={};$propObject$$.left=$docX$$-$width$$;$propObject$$.top=$docY$$-$height$$<0?10:$docY$$-$height$$;$animate$$1_top$$?$element$$.animate($propObject$$,250):$element$$.css($propObject$$)}function $onRetweet$$(){var $validUser$$=false,$t$$=$self$$.twitterProxy.twitterOBJ;if($t$$.isConnected())$validUser$$=true;else{$t$$.bind("authComplete",$onRetweet$$);$t$$.signIn()}$validUser$$?
$self$$.twitterProxy.twitterOBJ.Status.retweet($tweetID$$,{success:$showConfirmScreen$$,error:$showErrorScreen$$}):Log("user did not validate, authorizing...")}var $element$$=$("#modal-retweet-template"),$state$$="closed",$tweetID$$=null,$self$$=this;this.tweet=this.twitterProxy=null;this.open=function open($cs$$inline_72_tweet$$){var $as$$inline_73_html$$=$cs$$inline_72_tweet$$.getElement().clone();$element$$.find(".modal-dialog").text("Retweet this from "+$cs$$inline_72_tweet$$.screenName);$element$$.find(".confirmation").html("You retweeted<br/>"+
$cs$$inline_72_tweet$$.screenName+"'s tweet.");$as$$inline_73_html$$.find(".tweet-profile-image").remove();$as$$inline_73_html$$.find(".tweet-utility").remove();$as$$inline_73_html$$.find(".tweet-attachment").remove();$as$$inline_73_html$$.find(".tweet-copy-block").css("margin-left","0px");$as$$inline_73_html$$.find(".tweet-copy-block").css("font-family","arial");$as$$inline_73_html$$.find(".tweet-copy-block").css("font-size","11px");$(".modal-tweet-container").html($as$$inline_73_html$$);$tweetID$$=
$cs$$inline_72_tweet$$.tweetID;if($state$$=="closed"){$cs$$inline_72_tweet$$=$element$$.find(".confirmation-screen");$as$$inline_73_html$$=$element$$.find(".action-screen");$element$$.find(".error-screen").hide();$cs$$inline_72_tweet$$.hide();$as$$inline_73_html$$.show();$element$$.css("z-index",$overlay$$.z+1);$element$$.fadeIn(250);$overlay$$.open()}$position$$();$state$$="open"};$overlay$$.addEventListener("onModalOverlayClose",$onClose$$);(function decorateBTNS(){var $cBtn$$2_cancelBtn$$1_okBtn$$=
$element$$.find(".close-button");$cBtn$$2_cancelBtn$$1_okBtn$$.click($onClose$$);$cBtn$$2_cancelBtn$$1_okBtn$$.hover(function(){$(this).css("cursor","pointer")},function(){$(this).css("cursor","auto")});$cBtn$$2_cancelBtn$$1_okBtn$$=$element$$.find(".modal-cancel-button");$cBtn$$2_cancelBtn$$1_okBtn$$.click($onClose$$);$cBtn$$2_cancelBtn$$1_okBtn$$.hover(function(){$(this).css("cursor","pointer")},function(){$(this).css("cursor","auto")});$cBtn$$2_cancelBtn$$1_okBtn$$=$element$$.find(".modal-retweet-button");
$cBtn$$2_cancelBtn$$1_okBtn$$.click($onRetweet$$);$cBtn$$2_cancelBtn$$1_okBtn$$.hover(function(){$(this).css("cursor","pointer")},function(){$(this).css("cursor","auto")});$cBtn$$2_cancelBtn$$1_okBtn$$=$element$$.find(".modal-confirm-button");$cBtn$$2_cancelBtn$$1_okBtn$$.click($onClose$$);$cBtn$$2_cancelBtn$$1_okBtn$$.hover(function(){$(this).css("cursor","pointer")},function(){$(this).css("cursor","auto")})})();$element$$.css("position","fixed");$position$$(false);return this}
ModalReply.prototype=new EventDispatcher;ModalReply.constructor=ModalReply;
...
$element$$.find(".confirmation-screen"),$as$$=$element$$.find(".action-screen");$element$$.find(".error-screen").hide();$as$$.hide();$cs$$.show()}function $complete$$(){var $box$$=$("#reply-box iframe").contents().find("textarea");Log(" styling modal reply box css:"+$box$$.css("font"));var $button$$=$("#reply-box iframe").contents().find("button").parent(),$formButton$$=$("#reply-box iframe").contents().find("button");label=$(".action-screen iframe").contents().find("label");counter=$(".action-screen iframe").contents().find("#counter");
label.css("fontSize");label.css("font-size",12);label.css("color","#fff");counter.css("position","absolute");counter.css("color","#fff");counter.css("left","260px");counter.css("top","5px");counter.css("text-align","right");counter.css("width",80);counter.css("font-size",12);$box$$.css("background","transparent");$box$$.css("color","#fff");$button$$.css("background","#D53D36");$button$$.css("border","none");$formButton$$.css("color","#000");$formButton$$.css("text-shadow","none");$formButton$$.css("font-size",
"12px");$formButton$$.css("font-weight","bold");$formButton$$.css("text-transform","uppercase")}var $element$$=$("#modal-reply-template"),$state$$="closed",$self$$=this;this.tweet=null;this.open=function open($cs$$inline_91_tweet$$){if($cs$$inline_91_tweet$$){Log("status id");$element$$.find(".confirmation").html("Your reply to @"+$cs$$inline_91_tweet$$.screenName+"<br />was sent to twitter.")}if($state$$=="closed"){$("#reply-box").empty();$self$$.twitterProxy.getTweetBox("#reply-box",{height:70,
width:230,defaultContent:"@"+$cs$$inline_91_tweet$$.screenName,complete:$complete$$,label:"",onTweet:$showConfirmScreen$$,data:{in_reply_to_status_id:$cs$$inline_91_tweet$$.tweetID}});$cs$$inline_91_tweet$$=$element$$.find(".confirmation-screen");var $as$$=$element$$.find(".action-screen");$element$$.find(".error-screen").hide();$cs$$inline_91_tweet$$.hide();$as$$.show();$element$$.css("z-index",$overlay$$.z+1);$element$$.fadeIn(250);$overlay$$.open()}$position$$();$state$$="open"};this.twitterProxy=
null;$overlay$$.addEventListener("onModalOverlayClose",$onClose$$);(function decorateBTNS(){var $cBtn$$3_cancelBtn$$2_okBtn$$=$element$$.find(".close-button");$cBtn$$3_cancelBtn$$2_okBtn$$.click($onClose$$);$cBtn$$3_cancelBtn$$2_okBtn$$.hover(function(){$(this).css("cursor","pointer")},function(){$(this).css("cursor","auto")});$cBtn$$3_cancelBtn$$2_okBtn$$=$element$$.find(".modal-cancel-button");$cBtn$$3_cancelBtn$$2_okBtn$$.click($onClose$$);$cBtn$$3_cancelBtn$$2_okBtn$$.hover(function(){$(this).css("cursor",
...
function ModalFollow($overlay$$){function $onClose$$(){$element$$.fadeOut(250);$overlay$$.close();$state$$="closed"}function $showConfirmScreen$$(){var $cs$$=$element$$.find(".confirmation-screen"),$as$$=$element$$.find(".action-screen");$element$$.find(".error-screen").hide();$as$$.hide();$cs$$.show()}function $showErrorScreen$$(){var $cs$$=$element$$.find(".confirmation-screen"),$as$$=$element$$.find(".action-screen");$element$$.find(".error-screen").show();$as$$.hide();$cs$$.hide()}function $position$$($animate$$3_top$$){var $docY$$=
$(window).height()/2-100,$docX$$=$(document).width()/2,$height$$=$element$$.height()/2,$width$$=$element$$.width()/2,$propObject$$={};$propObject$$.left=$docX$$-$width$$;$propObject$$.top=$docY$$-$height$$<0?10:$docY$$-$height$$;$animate$$3_top$$?$element$$.animate($propObject$$,250):$element$$.css($propObject$$)}function $onFollow$$(){var $t$$12_validUser$$=false,$callbacks$$1_t$$=$self$$.twitterProxy.twitterOBJ;if($callbacks$$1_t$$.isConnected())$t$$12_validUser$$=true;else{$callbacks$$1_t$$.bind("authComplete",
$onFollow$$);$callbacks$$1_t$$.signIn()}if($t$$12_validUser$$){$t$$12_validUser$$=$self$$.twitterProxy.twitterOBJ;Log("follow user: "+$user$$);$callbacks$$1_t$$={success:$showConfirmScreen$$,error:$showErrorScreen$$};$t$$12_validUser$$.User.find($user$$).follow($callbacks$$1_t$$)}}var $element$$=$("#modal-follow-template"),$state$$="closed",$user$$=null,$self$$=this;this.tweet=this.tweetProxy=null;this.open=function open($cs$$inline_106_tweet$$){if($cs$$inline_106_tweet$$){$cs$$inline_106_tweet$$.getElement().clone();
$element$$.find(".modal-dialog").append().html('Start following<br /><span class="red">'+$cs$$inline_106_tweet$$.screenName+"</span>");$element$$.find(".confirmation").append().html('You are now following<br /><span class="red">'+$cs$$inline_106_tweet$$.screenName+"</span>")}$self$$.tweet=$cs$$inline_106_tweet$$;$user$$=$cs$$inline_106_tweet$$.screenName;Log("follow user: "+$user$$);if($state$$=="closed"){$cs$$inline_106_tweet$$=$element$$.find(".confirmation-screen");var $as$$=$element$$.find(".action-screen");
$element$$.find(".error-screen").hide();$cs$$inline_106_tweet$$.hide();$as$$.show();$element$$.css("z-index",$overlay$$.z+1);$element$$.fadeIn(250);$overlay$$.open()}$position$$();$state$$="open"};$overlay$$.addEventListener("onModalOverlayClose",$onClose$$);(function decorateBTNS(){var $cBtn$$4_cancelBtn$$3_fBtn_okBtn$$=$element$$.find(".close-button");$cBtn$$4_cancelBtn$$3_fBtn_okBtn$$.click($onClose$$);$cBtn$$4_cancelBtn$$3_fBtn_okBtn$$.hover(function(){$(this).css("cursor","pointer")},function(){$(this).css("cursor",
"auto")});$cBtn$$4_cancelBtn$$3_fBtn_okBtn$$=$element$$.find(".modal-cancel-button");$cBtn$$4_cancelBtn$$3_fBtn_okBtn$$.click($onClose$$);$cBtn$$4_cancelBtn$$3_fBtn_okBtn$$.hover(function(){$(this).css("cursor","pointer")},function(){$(this).css("cursor","auto")});$cBtn$$4_cancelBtn$$3_fBtn_okBtn$$=$element$$.find(".modal-follow-button");$cBtn$$4_cancelBtn$$3_fBtn_okBtn$$.click($onFollow$$);$cBtn$$4_cancelBtn$$3_fBtn_okBtn$$.hover(function(){$(this).css("cursor","pointer")},function(){$(this).css("cursor",
"auto")});$cBtn$$4_cancelBtn$$3_fBtn_okBtn$$=$element$$.find(".modal-confirm-button");$cBtn$$4_cancelBtn$$3_fBtn_okBtn$$.click($onClose$$);$cBtn$$4_cancelBtn$$3_fBtn_okBtn$$.hover(function(){$(this).css("cursor","pointer")},function(){$(this).css("cursor","auto")})})();$element$$.css("position","fixed");$position$$(false);return this}FavoriteModal.prototype=new EventDispatcher;FavoriteModal.constructor=FavoriteModal;
function FavoriteModal($overlay$$){function $onClose$$(){$element$$.fadeOut(250);$overlay$$.close();$state$$="closed"}function $showConfirmScreen$$(){var $cs$$=$element$$.find(".confirmation-screen"),$as$$=$element$$.find(".action-screen");$element$$.find(".error-screen").hide();$as$$.hide();$cs$$.show()}function $showErrorScreen$$(){var $cs$$=$element$$.find(".confirmation-screen"),$as$$=$element$$.find(".action-screen");$element$$.find(".error-screen").show();$as$$.hide();$cs$$.hide()}function $position$$($animate$$4_top$$){var $docY$$=
$(window).height()/2-100,$docX$$=$(document).width()/2,$height$$=$element$$.height()/2,$width$$=$element$$.width()/2,$propObject$$={};$propObject$$.left=$docX$$-$width$$;$propObject$$.top=$docY$$-$height$$<0?10:$docY$$-$height$$;$animate$$4_top$$?$element$$.animate($propObject$$,250):$element$$.css($propObject$$)}function $onFavorite$$(){Log("onFavorite");var $validUser$$=false,$t$$=$self$$.twitterProxy.twitterOBJ;if($t$$.isConnected())$validUser$$=true;else{$t$$.bind("authComplete",$onFavorite$$);
$t$$.signIn()}$validUser$$?$self$$.twitterProxy.twitterOBJ.Status.favorite($tweetID$$,{success:$showConfirmScreen$$,error:$showErrorScreen$$}):Log("user did not validate, authorizing...")}var $element$$=$("#modal-favorite-template"),$state$$="closed",$tweetID$$=null,$self$$=this;this.tweet=null;this.open=function open($cs$$inline_122_tweet$$){if($cs$$inline_122_tweet$$){$cs$$inline_122_tweet$$.getElement().clone();$element$$.find(".modal-dialog").append().html('Favorite this tweet from<br /><span class="red">'+
$cs$$inline_122_tweet$$.screenName+"</span>")}$tweetID$$=$cs$$inline_122_tweet$$.tweetID;$self$$.tweet=$cs$$inline_122_tweet$$;if($state$$=="closed"){$cs$$inline_122_tweet$$=$element$$.find(".confirmation-screen");var $as$$=$element$$.find(".action-screen");$element$$.find(".error-screen").hide();$cs$$inline_122_tweet$$.hide();$as$$.show();$element$$.css("z-index",$overlay$$.z+1);$element$$.fadeIn(250);$overlay$$.open()}$position$$();$state$$="open"};this.twitterProxy=null;$overlay$$.addEventListener("onModalOverlayClose",
$onClose$$);(function decorateBTNS(){var $cBtn$$5_cancelBtn$$4_fvtBtn_okBtn$$=$element$$.find(".close-button");$cBtn$$5_cancelBtn$$4_fvtBtn_okBtn$$.click($onClose$$);$cBtn$$5_cancelBtn$$4_fvtBtn_okBtn$$.hover(function(){$(this).css("cursor","pointer")},function(){$(this).css("cursor","auto")});$cBtn$$5_cancelBtn$$4_fvtBtn_okBtn$$=$element$$.find(".modal-cancel-button");$cBtn$$5_cancelBtn$$4_fvtBtn_okBtn$$.click($onClose$$);$cBtn$$5_cancelBtn$$4_fvtBtn_okBtn$$.hover(function(){$(this).css("cursor",
...
"pointer")},function(){$(this).css("cursor","auto")})})();$element$$.css("position","fixed");$position$$(false);return this}TRModel.prototype=new EventDispatcher;TRModel.constructor=TRModel;TRModel.constructor.id=0;
...
<<<<<<< HEAD
function TeamsModel(){function $poll$$(){$model$$.load(null,"jsonp")}function $setTeamColor$$($id$$,$color$$){$id$$=$id$$.toLowerCase();if($self$$.team_schema[$id$$])$self$$.team_schema[$id$$].color=$color$$}var $self$$=this,$model$$=new TRModel;$model$$.addEventListener("onDataChange",function onDataChange($data$$15_e$$){$data$$15_e$$=$data$$15_e$$.target.getData();if($teamsLoaded$$)for($colorValues$$inline_127_s$$ in $data$$15_e$$.streams){$stream$$=$data$$15_e$$.streams[$colorValues$$inline_127_s$$];
$breaks_team$$=$stream$$.name.split("-");if($breaks_team$$.length==3){var $breaks_team$$=$self$$.team_schema[$breaks_team$$[2]];if($breaks_team$$)$breaks_team$$.mentions=$stream$$.count.total}}else{for(var $colorValues$$inline_127_s$$ in $data$$15_e$$.streams){var $stream$$=$data$$15_e$$.streams[$colorValues$$inline_127_s$$];$breaks_team$$=$stream$$.name.split("-");if($breaks_team$$.length==3){var $teamData$$=$stream$$.description.split("|");$self$$.team_schema[$breaks_team$$[2]]={seed:$.trim($teamData$$[0]),
displayName:$.trim($teamData$$[1]),hashTag:$.trim($teamData$$[2]),shortName:$breaks_team$$[2],stream:$stream$$.full_name+"-curated",mentions:$stream$$.count.total};if($self$$.team_schema[$breaks_team$$[2]].shortName=="TA&M")$self$$.team_schema[$breaks_team$$[2]].shortName="TAM"}}$teamsLoaded$$=true}$colorValues$$inline_127_s$$={HAMP:{color:"#4892D3",name:"Hampton Pirates"},PRIN:{color:"#FF9408",name:"Princeton Tigers"},AKR:{color:"#CAB388",name:"Akron Zips"},SMU:{color:"#B10000",name:"Southern Methodist Mustangs"},
OAK:{color:"#9A803E",name:"Oakland Golden Grizzlies"},PITT:{color:"#CEC499",name:"Pittsburgh Panthers"},LIU:{color:"#777777",name:"Long Island Blackbirds"},FSU:{color:"#990000",name:"Florida State Seminoles"},CLEM:{color:"#F35B0F",name:"Clemson Tigers"},CONN:{color:"#2154A0",name:"Connecticut Huskies"},TEX:{color:"#CC5500",name:"Texas Longhorns"},GONZ:{color:"#5D4F97",name:"Gonzaga Bulldogs"},TEM:{color:"#BC0138",name:"Temple Owls"},ND:{color:"#C5B358",name:"Notre Dame Fighting Irish"},ODU:{color:"#93BFEB",
name:"Old Dominion Monarchs"},ARIZ:{color:"#C41E3A",name:"Arizona Wildcats"},UAB:{color:"#006600",name:"UAB Blazers"},ILL:{color:"#F77329",name:"Illinois Fighting Illini"},VAN:{color:"#997F3D",name:"Vanderbilt Commodores"},BYU:{color:"#1A4F86",name:"Brigham Young Cougars"},XAV:{color:"#3877B3",name:"Xavier Musketeers"},SJU:{color:"#CC0033",name:"St. John's Red Storm"},UNC:{color:"#99BFE5",name:"North Carolina Tar Heels"},GMU:{color:"#016600",name:"George Mason Patriots"},SPC:{color:"#3E81BE",name:"St. Peter's Peacocks"},
BU:{color:"#CC0000",name:"Boston University Terriers"},MEM:{color:"#3A6ED9",name:"Memphis Tigers"},ORU:{color:"#CFB53B",name:"Oral Roberts Golden Eagles"},UCLA:{color:"#0073CF",name:"UCLA Bruins"},MIZZ:{color:"#FFCC33",name:"Missouri Tigers"},SYR:{color:"#FF7F00",name:"Syracuse Orange"},UALR:{color:"#AD0000",name:"Arkansas-Little Rock Trojans"},MARQ:{color:"#FDBB30",name:"Marquette Golden Eagles"},KU:{color:"#0060A5",name:"Kansas Jayhawks"},TAM:{color:"#814D4C",name:"Texas A&M Aggies"},PUR:{color:"#B1946C",
name:"Purdue Boilermakers"},MORE:{color:"#004FA2",name:"Morehead State Eagles"},KSU:{color:"#633194",name:"Kansas State Wildcats"},DUKE:{color:"#3C7FBF",name:"Duke Blue Devils"},USC:{color:"#A50010",name:"USC Trojans"},BEL:{color:"#FF0000",name:"Belmont Bruins"},MSU:{color:"#4F8248",name:"Michigan State Spartans"},MICH:{color:"#F5D130",name:"Michigan Wolverines"},CIN:{color:"#E00122",name:"Cincinnati Bearcats"},UNLV:{color:"#FF2400",name:"UNLV Rebels"},WASH:{color:"#E8D3A2",name:"Washington Huskies"},
USU:{color:"#0066CC",name:"Utah State Aggies"},INST:{color:"#00669A",name:"Indiana State Sycamores"},LOU:{color:"#FF0000",name:"Louisville Cardinals"},FLA:{color:"#FF4A00",name:"Florida Gators"},ALST:{color:"#E9A900",name:"Alabama State Hornets"},OSU:{color:"#FF2000",name:"Ohio State Buckeyes"},BUT:{color:"#3877B3",name:"Butler Bulldogs"},WVU:{color:"#FFCC00",name:"West Virginia Mountaineers"},UTSA:{color:"#F47321",name:"Texas-San Antonio Roadrunners"},UNCA:{color:"#3877B3",name:"North Carolina-Asheville Bulldogs"},
GTWN:{color:"#999999",name:"Georgetown Hoyas"},WIS:{color:"#C32122",name:"Wisconsin Badgers"},UNCO:{color:"#FFCC33",name:"Northern Colorado Bears"},RICH:{color:"#9E0712",name:"Richmond Spiders"},VILL:{color:"#B8D7E4",name:"Villanova Wildcats"},VCU:{color:"#F8B800",name:"Virginia Commonwealth Rams"},WOF:{color:"#CFB53B",name:"Wofford Terriers"},BUCK:{color:"#FF9900",name:"Bucknell Bison"},TENN:{color:"#F77F00",name:"Tennessee Volunteers"},SDSU:{color:"#A81933",name:"San Diego State Aztecs"},UCSB:{color:"#EAAF0F",
name:"UC Santa Barbara Gauchos"},UK:{color:"#3877B3",name:"Kentucky Wildcats"},UGA:{color:"#FF0000",name:"Georgia Bulldogs"},PSU:{color:"#3877B3",name:"Penn State Nittany Lions"}};for(c in $colorValues$$inline_127_s$$)$setTeamColor$$(c,$colorValues$$inline_127_s$$[c].color);dispatchEvent("onTeamModelReady",$self$$);clearInterval($self$$.interval);$self$$.interval=setInterval($poll$$,$INTERVAL_TIME$$)});var $INTERVAL_TIME$$=5E3,$teamsLoaded$$=false;this.getTeam=function getTeam($id$$){$id$$=$id$$.toLowerCase();
return $self$$.team_schema[$id$$]};this.getAll=function getAll(){return $self$$.team_schema};this.setTeamColor=$setTeamColor$$;Log("Fetching team data");$self$$.team_schema={};$model$$.setStream("http://tweetriver.com/mr_mm_2011.json");$model$$.load(null,"jsonp");return $self$$}Tweet.prototype=new EventDispatcher;Tweet.constructor=Tweet;
=======
function TeamsModel(){function $poll$$(){$model$$.load(null,"jsonp")}function $setTeamColor$$($id$$,$color$$){$id$$=$id$$.toLowerCase();if($self$$.team_schema[$id$$])$self$$.team_schema[$id$$].color=$color$$}function $sortTeams$$($o$$){var $sorted$$={},$key$$,$a$$0$$=[];for($key$$ in $o$$)$o$$.hasOwnProperty($key$$)&&$key$$!="all"&&$key$$!="experts"&&$key$$!="verizon"&&$a$$0$$.push({sn:$key$$,name:$o$$[$key$$].displayName});$a$$0$$=$a$$0$$.sort(function($a$$,$b$$){return $a$$.name>$b$$.name?1:$a$$.name<
$b$$.name?-1:0});for($key$$=0;$key$$<$a$$0$$.length;$key$$++)$sorted$$[$a$$0$$[$key$$].sn]=$o$$[$a$$0$$[$key$$].sn];return $sorted$$}var $self$$=this,$model$$=new TRModel;$model$$.addEventListener("onDataChange",function onDataChange($data$$15_e$$){$data$$15_e$$=$data$$15_e$$.target.getData();if($teamsLoaded$$)for($colorValues$$inline_127_s$$ in $data$$15_e$$.streams){$stream$$=$data$$15_e$$.streams[$colorValues$$inline_127_s$$];$breaks_team$$=$stream$$.name.split("-");if($breaks_team$$.length==3){var $breaks_team$$=
$self$$.team_schema[$breaks_team$$[2]];if($breaks_team$$)$breaks_team$$.mentions=$stream$$.count.total}}else{for(var $colorValues$$inline_127_s$$ in $data$$15_e$$.streams){var $stream$$=$data$$15_e$$.streams[$colorValues$$inline_127_s$$];$breaks_team$$=$stream$$.name.split("-");if($breaks_team$$.length==3){var $teamData$$=$stream$$.description.split("|");$self$$.team_schema[$breaks_team$$[2]]={seed:$.trim($teamData$$[0]),displayName:$.trim($teamData$$[1]),hashTag:$.trim($teamData$$[2]),shortName:$breaks_team$$[2],
stream:$stream$$.full_name+"-curated",mentions:$stream$$.count.total};if($self$$.team_schema[$breaks_team$$[2]].shortName=="TA&M")$self$$.team_schema[$breaks_team$$[2]].shortName="TAM"}}$self$$.team_schema=$sortTeams$$($self$$.team_schema);$teamsLoaded$$=true}$colorValues$$inline_127_s$$={HAMP:{color:"#4892D3",name:"Hampton Pirates"},PRIN:{color:"#FF9408",name:"Princeton Tigers"},AKR:{color:"#CAB388",name:"Akron Zips"},SMU:{color:"#B10000",name:"Southern Methodist Mustangs"},OAK:{color:"#9A803E",
name:"Oakland Golden Grizzlies"},PITT:{color:"#CEC499",name:"Pittsburgh Panthers"},LIU:{color:"#777777",name:"Long Island Blackbirds"},FSU:{color:"#990000",name:"Florida State Seminoles"},CLEM:{color:"#F35B0F",name:"Clemson Tigers"},CONN:{color:"#2154A0",name:"Connecticut Huskies"},TEX:{color:"#CC5500",name:"Texas Longhorns"},GONZ:{color:"#5D4F97",name:"Gonzaga Bulldogs"},TEM:{color:"#BC0138",name:"Temple Owls"},ND:{color:"#C5B358",name:"Notre Dame Fighting Irish"},ODU:{color:"#93BFEB",name:"Old Dominion Monarchs"},
ARIZ:{color:"#C41E3A",name:"Arizona Wildcats"},UAB:{color:"#006600",name:"UAB Blazers"},ILL:{color:"#F77329",name:"Illinois Fighting Illini"},VAN:{color:"#997F3D",name:"Vanderbilt Commodores"},BYU:{color:"#1A4F86",name:"Brigham Young Cougars"},XAV:{color:"#3877B3",name:"Xavier Musketeers"},SJU:{color:"#CC0033",name:"St. John's Red Storm"},UNC:{color:"#99BFE5",name:"North Carolina Tar Heels"},GMU:{color:"#016600",name:"George Mason Patriots"},SPC:{color:"#3E81BE",name:"St. Peter's Peacocks"},BU:{color:"#CC0000",
name:"Boston University Terriers"},MEM:{color:"#3A6ED9",name:"Memphis Tigers"},ORU:{color:"#CFB53B",name:"Oral Roberts Golden Eagles"},UCLA:{color:"#0073CF",name:"UCLA Bruins"},MIZZ:{color:"#FFCC33",name:"Missouri Tigers"},SYR:{color:"#FF7F00",name:"Syracuse Orange"},UALR:{color:"#AD0000",name:"Arkansas-Little Rock Trojans"},MARQ:{color:"#FDBB30",name:"Marquette Golden Eagles"},KU:{color:"#0060A5",name:"Kansas Jayhawks"},TAM:{color:"#814D4C",name:"Texas A&M Aggies"},PUR:{color:"#B1946C",name:"Purdue Boilermakers"},
MORE:{color:"#004FA2",name:"Morehead State Eagles"},KSU:{color:"#633194",name:"Kansas State Wildcats"},DUKE:{color:"#3C7FBF",name:"Duke Blue Devils"},USC:{color:"#A50010",name:"USC Trojans"},BEL:{color:"#FF0000",name:"Belmont Bruins"},MSU:{color:"#4F8248",name:"Michigan State Spartans"},MICH:{color:"#F5D130",name:"Michigan Wolverines"},CIN:{color:"#E00122",name:"Cincinnati Bearcats"},UNLV:{color:"#FF2400",name:"UNLV Rebels"},WASH:{color:"#E8D3A2",name:"Washington Huskies"},USU:{color:"#0066CC",name:"Utah State Aggies"},
INST:{color:"#00669A",name:"Indiana State Sycamores"},LOU:{color:"#FF0000",name:"Louisville Cardinals"},FLA:{color:"#FF4A00",name:"Florida Gators"},ALST:{color:"#E9A900",name:"Alabama State Hornets"},OSU:{color:"#FF2000",name:"Ohio State Buckeyes"},BUT:{color:"#3877B3",name:"Butler Bulldogs"},WVU:{color:"#FFCC00",name:"West Virginia Mountaineers"},UTSA:{color:"#F47321",name:"Texas-San Antonio Roadrunners"},UNCA:{color:"#3877B3",name:"North Carolina-Asheville Bulldogs"},GTWN:{color:"#999999",name:"Georgetown Hoyas"},
WIS:{color:"#C32122",name:"Wisconsin Badgers"},UNCO:{color:"#FFCC33",name:"Northern Colorado Bears"},RICH:{color:"#9E0712",name:"Richmond Spiders"},VILL:{color:"#B8D7E4",name:"Villanova Wildcats"},VCU:{color:"#F8B800",name:"Virginia Commonwealth Rams"},WOF:{color:"#CFB53B",name:"Wofford Terriers"},BUCK:{color:"#FF9900",name:"Bucknell Bison"},TENN:{color:"#F77F00",name:"Tennessee Volunteers"},SDSU:{color:"#A81933",name:"San Diego State Aztecs"},UCSB:{color:"#EAAF0F",name:"UC Santa Barbara Gauchos"},
UK:{color:"#3877B3",name:"Kentucky Wildcats"},UGA:{color:"#FF0000",name:"Georgia Bulldogs"},PSU:{color:"#3877B3",name:"Penn State Nittany Lions"}};for(c in $colorValues$$inline_127_s$$)$setTeamColor$$(c,$colorValues$$inline_127_s$$[c].color);dispatchEvent("onTeamModelReady",$self$$);clearInterval($self$$.interval);$self$$.interval=setInterval($poll$$,$INTERVAL_TIME$$)});var $INTERVAL_TIME$$=5E3,$teamsLoaded$$=false;this.getTeam=function getTeam($id$$){$id$$=$id$$.toLowerCase();return $self$$.team_schema[$id$$]};
this.getAll=function getAll(){return $self$$.team_schema};this.setTeamColor=$setTeamColor$$;Log("Fetching team data");$self$$.team_schema={};$model$$.setStream("http://tweetriver.com/mr_mm_2011.json");$model$$.load(null,"jsonp");return $self$$}Tweet.prototype=new EventDispatcher;Tweet.constructor=Tweet;
>>>>>>> d613b7797f4b198bcbc3277b1fbfc4f7e7231852
...
$element$$.find(".tweet-attachment").css("background-image","url("+$thumb$$.src+")")});return this}var a;$(document).ready(function(){a=new Application});
...
$teams$$.addEventListener("onTeamModelReady",function onTeamModelReady(){$teams$$.removeEventListener("onTeamModelReady",this);$nav$$.addEventListener("onRoundSelect",$onRoundSelect$$);$nav$$.setAvailableRounds(["round1","round2"]);$selector$$.addEventListener("onTeamSelect",$onTeamSelect$$);$selector$$.buildList($teams$$);$schedules$$.addEventListener("onTeamSelect",$onTeamSelect$$);$schedules$$.addEventListener("onHashTagClick",$onHashTagClick$$);$schedules$$.setTeamModel($teams$$);$nav$$.activateRound("round1")})}
TweetListController.prototype=new EventDispatcher;TweetListController.constructor=TweetListController;
function TweetListController(){function $selectTeam$$($nameElement$$inline_140_t$$inline_133_team$$){clearInterval($autoStartInt$$);Log("team selected! "+$nameElement$$inline_140_t$$inline_133_team$$);var $obj$$=$nameElement$$inline_140_t$$inline_133_team$$.team,$name$$=$nameElement$$inline_140_t$$inline_133_team$$.team.displayName?$nameElement$$inline_140_t$$inline_133_team$$.team.displayName:$obj$$.name,$hState_orgSize$$=$name$$.indexOf("ALL TEAMS")==-1?"show":"hide",$f$$="http://tweetriver.com/mr_mm_2011/mm-2011-"+
$obj$$.shortName+".json";$feedColor$$=$obj$$.color;$setFeed$$($f$$);$updateColors$$();$nameElement$$inline_140_t$$inline_133_team$$=$nameElement$$inline_140_t$$inline_133_team$$.team.hashTag;if($hState_orgSize$$=="show"){$(".spirit-bubble").text("go "+$nameElement$$inline_140_t$$inline_133_team$$);$("#team-selector").hide();$(".spirit-bubble").show();$("#show-all-streams").show()}else{$(".spirit-bubble").hide();$("#team-selector").show();$("#show-all-streams").hide()}$hState_orgSize$$=25;$nameElement$$inline_140_t$$inline_133_team$$=
$("#stream-header h2");$nameElement$$inline_140_t$$inline_133_team$$.css("font-size",$hState_orgSize$$);$nameElement$$inline_140_t$$inline_133_team$$.text($name$$);for(Log("name width: "+$nameElement$$inline_140_t$$inline_133_team$$.width());$nameElement$$inline_140_t$$inline_133_team$$.width()>220;){$hState_orgSize$$-=1;$nameElement$$inline_140_t$$inline_133_team$$.css("font-size",$hState_orgSize$$)}}function $setFeed$$($feedURL$$2_i$$){$("#loadmore-count").hide();$removeScrollbar$$();$model$$.setStream($feedURL$$2_i$$);
...
$model$$.addEventListener("onDataChange",function onDataChange($data$$inline_162_e$$){$loader$$.hide();$data$$inline_162_e$$=$data$$inline_162_e$$.target.getData();var $i$$=0,$total$$=$data$$inline_162_e$$.length-1,$t$$=null;$tweets$$=[];$element$$.css("opacity",0);$("#loadmore-count").hide();for($("#loadmore").show();$i$$<=$total$$;$i$$++){$t$$=new Tweet;$t$$.setTwitterAPI($twitterProxy$$);$tweets$$.push($t$$);$addListeners$$($t$$);$t$$.setData($data$$inline_162_e$$[$i$$]);$element$$.append($t$$.getHTML())}$addScrollbar$$();
$updateColors$$();$element$$.animate({opacity:1},500);dispatchEvent("tweetListLoaded",self);$lastID$$=$data$$inline_162_e$$[0].order_id;clearInterval($updateInt$$);$updateInt$$=setTimeout($poll$$,1E4)});$updateModel$$.addEventListener("onDataChange",function onDataUpdate($data$$16_e$$){Log("updating new tweets: "+$data$$16_e$$.target.getData().length);$data$$16_e$$=$data$$16_e$$.target.getData();var $total$$=$data$$16_e$$.length-1,$i$$=0,$t$$;if($total$$>=0){$("#loadmore-count").text($total$$+1+" New Tweets");
...
<<<<<<< HEAD
clearInterval($updateInt$$);$updateInt$$=setTimeout($poll$$,1E4)});Tweet.constructor.tweetTemplate=$("#template-tweet").html();$("#template-tweet").remove();$autoStartInt$$=setTimeout(function autoStart(){$selectTeam$$({team:{displayName:"ALL TEAMS",shortName:"all",name:"ALL TEAMS",color:"#ED1F24"}})},1500);return this}ScheduleController.prototype=new EventDispatcher;ScheduleController.constructor=ScheduleController;
=======
clearInterval($updateInt$$);$updateInt$$=setTimeout($poll$$,1E4)});Tweet.constructor.tweetTemplate=$("#template-tweet").html();$("#template-tweet").remove();$autoStartInt$$=setTimeout(function autoStart(){$selectTeam$$({team:{displayName:"ALL TEAMS",shortName:"all",name:"ALL TEAMS",color:"#ED1F24"}})},500);return this}ScheduleController.prototype=new EventDispatcher;ScheduleController.constructor=ScheduleController;
>>>>>>> d613b7797f4b198bcbc3277b1fbfc4f7e7231852
function ScheduleController(){function $getFeedsForRound$$($r_round$$){var $dates_feed$$=$getRoundDates$$($r_round$$);$r_round$$=[$dates_feed$$.start.clone()];for($feedURLs$$=[];$dates_feed$$.start<$dates_feed$$.end;){$dates_feed$$.start.add({days:1});var $d$$=$dates_feed$$.start.clone();$r_round$$.push($d$$)}for($d$$ in $r_round$$){$dates_feed$$=feedLocation+"events-"+$r_round$$[$d$$].toString("yyyyMMdd")+".json";$feedURLs$$.push($dates_feed$$)}}function $getGamesForRound$$($game$$1_round$$){var $eligibleGames$$=
[];$getRoundDates$$($game$$1_round$$);for(var $g$$ in $self$$.scheduleData){$game$$1_round$$=$self$$.scheduleData[$g$$];var $allow$$=true;for(c in $game$$1_round$$.competitor){if($game$$1_round$$.competitor[c].shortName=="TA&M")$game$$1_round$$.competitor[c].shortName="TAM";if(!$self$$.teams.getTeam($game$$1_round$$.competitor[c].shortName))if($game$$1_round$$.competitor[c].shortName!="TBA")$allow$$=false}$allow$$&&$eligibleGames$$.push($game$$1_round$$)}return $eligibleGames$$}function $poll$$(){$getFeedsForRound$$($self$$.loadedRound);
for(var $f$$ in $feedURLs$$){$model$$0$$.setStream($feedURLs$$[$f$$]);$model$$0$$.loadJSON()}Log("Polling scores..")}function $sortGames$$(){$games$$=$games$$.sort(function($a$$,$b$$){return $a$$.date-$b$$.date});for(g in $games$$)$games$$[g].view.appendTo("#schedule-container")}function $teamClick$$($obj$$){$self$$.selected={team:$obj$$.target.selected};dispatchEvent("onTeamSelect",$self$$)}function $onHashTagClick$$($obj$$){$self$$.hashTag=$obj$$.target.hashTag;dispatchEvent("onHashTagClick",$self$$);
return false}function $getRoundDates$$($round$$){rounds={round1:{start:new Date(2011,2,15),end:new Date(2011,2,16)},round2:{start:new Date(2011,2,17),end:new Date(2011,2,18)},round3:{start:new Date(2011,2,19),end:new Date(2011,2,20)},regionals:{start:new Date(2011,2,24),end:new Date(2011,2,27)},finals:{start:new Date(2011,3,2),end:new Date(2011,3,2)},championship:{start:new Date(2011,3,4),end:new Date(2011,3,4)}};return rounds[$round$$]}var $self$$=this,$model$$0$$=new TRModel,$feedURLs$$=[],$games$$=
[],$streamLoadCount$$=0;$model$$0$$.addEventListener("onDataChange",function onDataChange($data$$18_e$$){$data$$18_e$$=$data$$18_e$$.target.getData();$self$$.scheduleData=$data$$18_e$$.events.event;$data$$18_e$$=$getGamesForRound$$($self$$.loadedRound);if($streamLoadCount$$>0){$streamLoadCount$$--;$("#scoreboard-loader").hide();$($data$$18_e$$).each(function(){var $data$$inline_170_game$$=$(this)[0];$data$$inline_170_game$$=new GameController($data$$inline_170_game$$,$self$$.teams);$games$$.push($data$$inline_170_game$$);
$data$$inline_170_game$$.addEventListener("onTeamSelect",$teamClick$$);$data$$inline_170_game$$.addEventListener("onHashTagClick",$onHashTagClick$$);if($data$$inline_170_game$$.active&&$self$$.firstActive==null)$self$$.firstActive=$data$$inline_170_game$$});$self$$.firstActive&&$self$$.firstActive.view.position();if($streamLoadCount$$==0){$sortGames$$();$(".schedule-scrollbar").scrollbar({handleHeight:151,arrows:false})}}else $($data$$18_e$$).each(function(){var $data$$=$(this)[0];for(game in $games$$)$games$$[game].id==
$data$$.id&&$games$$[game].update($data$$)})});$self$$.loadRound=function loadRound($round$$){$getFeedsForRound$$($round$$);Log("Loading round: "+$round$$+" from "+feedLocation);$games$$=[];var $l$$=$("#scoreboard-loader").detach();$("#schedule-container").empty();$("#schedule_list .scrollbar-pane").remove();$("#schedule_list .scrollbar-handle-container").remove();$("#schedule_list .scrollbar-handle-up").remove();$("#schedule_list .scrollbar-handle-down").remove();$("#schedule-container").prepend($l$$);
$streamLoadCount$$=$feedURLs$$.length;for(var $f$$ in $feedURLs$$){$model$$0$$.setStream($feedURLs$$[$f$$]);$model$$0$$.loadJSON()}clearInterval($self$$.interval);$self$$.interval=setInterval($poll$$,5E3);$("#scoreboard-loader").show();$self$$.loadedRound=$round$$};$self$$.setTeamModel=function setTeamModel($model$$){$self$$.teams=$model$$};return this}GameController.prototype=new EventDispatcher;GameController.constructor=GameController;
...
0;$c$$.name=$c$$.shortName}else{$c$$.name=$c$$.customData.displayName;$c$$.hashTag=$c$$.customData.hashTag;$c$$.color=$c$$.customData.color}if($c$$.name.length>22)$c$$.name=$c$$.shortName}if($data$$.eventstatus.status=="FINAL"){$templateData$$.game.status="final";$templateData$$.game.period="final";$self$$.active=false}else if($data$$.eventstatus.status=="SCHEDULED"){$templateData$$.game.status="current";$templateData$$.game.period=$templateData$$.date.toString("M/d");$self$$.active=false}else{if($data$$.eventstatus.status==
"INTERMISSION"){$templateData$$.game.status="current";$templateData$$.game.period="Half"}else{$templateData$$.game.status="current";$templateData$$.game.period=Utils.ordinal($data$$.eventstatus.curPeriod)}$self$$.active=true}return $self$$.templateData=$templateData$$}function $teamClick$$($obj$$){$self$$.selected=$obj$$.data.teamId;$obj$$.data.teamId.name!="TBA"&&dispatchEvent("onTeamSelect",$self$$)}function $hashTagClick$$(){$self$$.hashTag="Go "+$(this).text()+"!";dispatchEvent("onHashTagClick",
$self$$);return false}var $self$$=this;$self$$.update=function update($data$$22_viewData$$){$data$$22_viewData$$=$sanitizeData$$($data$$22_viewData$$);$self$$.visitorScore.text($data$$22_viewData$$.visitingTeam.score);$self$$.homeScore.text($data$$22_viewData$$.homeTeam.score);$self$$.period.text($data$$22_viewData$$.game.period);$self$$.view.data($data$$22_viewData$$);$visualizeWL$$();$data$$22_viewData$$.game.status=="final"&&$self$$.view.addClass("game-final")};$self$$.setTeamModel=function setTeamModel($model$$){$self$$.teams=
$model$$};(function init($data$$,$model$$){$self$$.id=$data$$.id;$self$$.teams=$model$$;$model$$.addEventListener("onTeamModelReady",$onTeamUpdate$$);var $viewData$$=$sanitizeData$$($data$$);$self$$.view=$createView$$($viewData$$);$visualizeWL$$()})($gameData$$,$model$$0$$);return $self$$}NavController.prototype=new EventDispatcher;NavController.constructor=NavController;
...
function TeamSelectorController(){function $activateLinks$$(){$(".team-column a").each(function(){$(this).click(function(){var $teamlist$$=$self$$.teams.getAll(),$tid$$=$(this).attr("id");$self$$.selected={team:$teamlist$$[$tid$$]};$.cookie("team",$tid$$,{expires:30,path:"/"});dispatchEvent("onTeamSelect",$self$$);return false})})}var $self$$=this;$self$$.buildList=function buildList($cTeam$$inline_186_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_187_teams$$){$self$$.teams=$cTeam$$inline_186_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_187_teams$$;
$cTeam$$inline_186_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_187_teams$$=[];var $teamlist$$1_tid$$=$self$$.teams.getAll();for(t in $teamlist$$1_tid$$)$cTeam$$inline_186_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_187_teams$$.push({shortName:$teamlist$$1_tid$$[t].shortName,name:$teamlist$$1_tid$$[t].displayName});$.template("columns",'{{each columns}}<ul class="team-column">{{each $value}}<li><a href="#" id="${$value.shortName}">${$value.name}</a></li>{{/each}}</ul>{{/each}}');
$cTeam$$inline_186_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_187_teams$$=[$cTeam$$inline_186_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_187_teams$$.splice(0,10),$cTeam$$inline_186_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_187_teams$$.splice(0,12),$cTeam$$inline_186_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_187_teams$$.splice(0,12),$cTeam$$inline_186_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_187_teams$$.splice(0,
10),$cTeam$$inline_186_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_187_teams$$.splice(0,11),$cTeam$$inline_186_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_187_teams$$.splice(0,11)];$cTeam$$inline_186_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_187_teams$$=$.tmpl("columns",{columns:$cTeam$$inline_186_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_187_teams$$});$("#team-selector a").qtip({content:$cTeam$$inline_186_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_187_teams$$,
show:"mouseover",hide:{fixed:true},api:{onRender:$activateLinks$$},style:{tip:"bottomRight",width:700,border:{width:0,radius:5,color:"#fff"}},position:{corner:{target:"topMiddle",tooltip:"bottomRight"}}});$cTeam$$inline_186_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_187_teams$$=null;if($.cookie("team")){$cTeam$$inline_186_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_187_teams$$=$self$$.teams.getAll();$teamlist$$1_tid$$=$.cookie("team");$cTeam$$inline_186_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_187_teams$$=
{team:$cTeam$$inline_186_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_187_teams$$[$teamlist$$1_tid$$]}}if($cTeam$$inline_186_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_187_teams$$){$self$$.selected=$cTeam$$inline_186_columnList_faveTeam_teamData$$1_teamListView_teamlist$$inline_187_teams$$;dispatchEvent("onTeamSelect",$self$$)}};return $self$$};