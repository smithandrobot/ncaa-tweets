...
displayName:$.trim($teamData$$[1]),hashTag:$.trim($teamData$$[2]),shortName:$breaks_team$$[2],stream:$stream$$.full_name+"-curated",mentions:$stream$$.count.total}}}$teamsLoaded$$=true}$colorValues$$inline_138_s$$={HAMP:{color:"#005299",name:"Hampton Pirates"},PRIN:{color:"#FF9408",name:"Princeton Tigers"},AKR:{color:"#001D44",name:"Akron Zips"},SMU:{color:"#E73139",name:"Southern Methodist Mustangs"},OAK:{color:"#04091C",name:"Oakland Golden Grizzlies"},PITT:{color:"#00224A",name:"Pittsburgh Panthers"},
LIU:{color:"#000000",name:"Long Island Blackbirds"},FSU:{color:"#7F001B",name:"Florida State Seminoles"},CLEM:{color:"#F35B0F",name:"Clemson Tigers"},CONN:{color:"#001D40",name:"Connecticut Huskies"},TEX:{color:"#EF7321",name:"Texas Longhorns"},GONZ:{color:"#37225F",name:"Gonzaga Bulldogs"},TEM:{color:"#BC0138",name:"Temple Owls"},ND:{color:"#00122B",name:"Notre Dame Fighting Irish"},ODU:{color:"#003665",name:"Old Dominion Monarchs"},ARIZ:{color:"#002449",name:"Arizona Wildcats"},UAB:{color:"#003B28",
name:"UAB Blazers"},ILL:{color:"#F77329",name:"Illinois Fighting Illini"},VAN:{color:"#000000",name:"Vanderbilt Commodores"},BYU:{color:"#001C3C",name:"Brigham Young Cougars"},XAV:{color:"#004B80",name:"Xavier Musketeers"},SJU:{color:"#CC0033",name:"St. John's Red Storm"},UNC:{color:"#99BFE5",name:"North Carolina Tar Heels"},GMU:{color:"#016600",name:"George Mason Patriots"},SPC:{color:"#001555",name:"St. Peter's Peacocks"},BU:{color:"#CC0000",name:"Boston University Terriers"},MEM:{color:"#002447",
name:"Memphis Tigers"},ORU:{color:"#002955",name:"Oral Roberts Golden Eagles"},UCLA:{color:"#004775",name:"UCLA Bruins"},MIZZ:{color:"#000000",name:"Missouri Tigers"},SYR:{color:"#002045",name:"Syracuse Orange"},UALR:{color:"#AD0000",name:"Arkansas-Little Rock Trojans"},MARQ:{color:"#083963",name:"Marquette Golden Eagles"},KU:{color:"#0060A5",name:"Kansas Jayhawks"},"TA&M":{color:"#6A3333",name:"Texas A&M Aggies"},PUR:{color:"#211818",name:"Purdue Boilermakers"},MORE:{color:"#004FA2",name:"Morehead State Eagles"},
KSU:{color:"#633194",name:"Kansas State Wildcats"},DUKE:{color:"#004582",name:"Duke Blue Devils"},USC:{color:"#A50010",name:"USC Trojans"},BEL:{color:"#182142",name:"Belmont Bruins"},MSU:{color:"#226B31",name:"Michigan State Spartans"},MICH:{color:"#001531",name:"Michigan Wolverines"},CIN:{color:"#000000",name:"Cincinnati Bearcats"},UNLV:{color:"#000000",name:"UNLV Rebels"},WASH:{color:"#3E3468",name:"Washington Huskies"},USU:{color:"#020767",name:"Utah State Aggies"},INST:{color:"#00669A",name:"Indiana State Sycamores"},
LOU:{color:"#AD000A",name:"Louisville Cardinals"},FLA:{color:"#002D69",name:"Florida Gators"},ALST:{color:"#E9A900",name:"Alabama State Hornets"},OSU:{color:"#A00612",name:"Ohio State Buckeyes"},BUT:{color:"#0D1361",name:"Butler Bulldogs"},WVU:{color:"#001124",name:"West Virginia Mountaineers"},UTSA:{color:"#113B7D",name:"Texas-San Antonio Roadrunners"},UNCA:{color:"#092575",name:"North Carolina-Asheville Bulldogs"},GTWN:{color:"#001B50",name:"Georgetown Hoyas"},WIS:{color:"#C32122",name:"Wisconsin Badgers"},
UNCO:{color:"#0E1831",name:"Northern Colorado Bears"},RICH:{color:"#9E0712",name:"Richmond Spiders"},VILL:{color:"#002D5B",name:"Villanova Wildcats"},VCU:{color:"#929292",name:"Virginia Commonwealth Rams"},WOF:{color:"#000000",name:"Wofford Terriers"},BUCK:{color:"#084280",name:"Bucknell Bison"},TENN:{color:"#D37907",name:"Tennessee Volunteers"},SDSU:{color:"#231F20",name:"San Diego State Aztecs"},UCSB:{color:"#101084",name:"UC Santa Barbara Gauchos"},UK:{color:"#004177",name:"Kentucky Wildcats"},
UGA:{color:"#A0000B",name:"Georgia Bulldogs"},PSU:{color:"#002148",name:"Penn State Nittany Lions"}};for(c in $colorValues$$inline_138_s$$)$setTeamColor$$(c,$colorValues$$inline_138_s$$[c].color);dispatchEvent("onTeamModelReady",$self$$);clearInterval($self$$.interval);$self$$.interval=setInterval($poll$$,$INTERVAL_TIME$$)});var $INTERVAL_TIME$$=5E3,$teamsLoaded$$=false;this.getTeam=function getTeam($id$$){$id$$=$id$$.toLowerCase();return $self$$.team_schema[$id$$]};this.getAll=function getAll(){return $self$$.team_schema};
...
$model$$.addEventListener("onDataChange",function onDataChange($data$$inline_173_e$$){$loader$$.hide();$data$$inline_173_e$$=$data$$inline_173_e$$.target.getData();var $i$$=0,$total$$=$data$$inline_173_e$$.length-1,$t$$=null;$tweets$$=[];$element$$.css("opacity",0);for($("#loadmore-count").hide();$i$$<=$total$$;$i$$++){$t$$=new Tweet;$tweets$$.push($t$$);$addListeners$$($t$$);$t$$.setData($data$$inline_173_e$$[$i$$]);$element$$.append($t$$.getHTML())}$addScrollbar$$();$updateColors$$();$element$$.animate({opacity:1},
500);dispatchEvent("tweetListLoaded",self);$lastID$$=$data$$inline_173_e$$[0].order_id;clearInterval($updateInt$$);$updateInt$$=setTimeout($poll$$,1E4)});$updateModel$$.addEventListener("onDataChange",function onDataUpdate($data$$16_e$$){$data$$16_e$$=$data$$16_e$$.target.getData();var $total$$=$data$$16_e$$.length-1,$i$$=0,$t$$;if($total$$>=0){$("#loadmore-count").text($total$$+1+" New Tweets");$("#loadmore-count").fadeIn(300);$newTweets$$=[];for($i$$=0;$i$$<=$total$$;$i$$++){$t$$=new Tweet;$t$$.setData($data$$16_e$$[$i$$]);
$newTweets$$.push($t$$)}}else $("#loadmore-count").fadeOut(300);clearInterval($updateInt$$);$updateInt$$=setTimeout($poll$$,1E4)});(function enableShowAllTeams(){var $s$$=$("#show-all-streams");$s$$.click(function(){$selectTeam$$({team:{displayName:"ALL TEAMS",shortName:"all",name:"ALL TEAMS",color:"#ED1F24"}})});$s$$.hover(function(){$(this).css("cursor","pointer")},function(){$(this).css("cursor","auto")});$.cookie("team",null)})();$("#loadmore-count").click(function updateList(){clearInterval($updateInt$$);
$removeScrollbar$$();$("#loadmore-count").hide();var $total$$=$newTweets$$.length-1,$t$$=null,$i$$=0;$lastID$$=$newTweets$$[0].orderID;Log("last id: "+$lastID$$);for($newTweets$$.reverse();$i$$<=$total$$;$i$$++){$t$$=$newTweets$$[$i$$];$tweets$$.unshift($t$$);$addListeners$$($t$$);$element$$.prepend($t$$.getHTML())}$addScrollbar$$();$updateColors$$();clearInterval($updateInt$$);$updateInt$$=setTimeout($poll$$,1E4)});Tweet.constructor.tweetTemplate=$("#template-tweet").html();$("#template-tweet").remove();
$autoStartInt$$=setTimeout(function autoStart(){$selectTeam$$({team:{displayName:"ALL TEAMS",shortName:"all",name:"ALL TEAMS",color:"#ED1F24"}})},500);return this}ScheduleController.prototype=new EventDispatcher;ScheduleController.constructor=ScheduleController;
...
{game:{id:$data$$.id}};$templateData$$.date=Date.parse($data$$.date);$self$$.date=$templateData$$.date;for(cid in $data$$.competitor){var $c$$=$data$$.competitor[cid];if($c$$.homeaway=="home"){$templateData$$.homeTeam=$c$$;$self$$.homeTeam=$c$$}else{$templateData$$.visitingTeam=$c$$;$self$$.visitingTeam=$c$$}$c$$.customData=$self$$.teams.getTeam($c$$.shortName);if($c$$.customData==undefined){$c$$.customData={};$c$$.customData.hashTag="#team";$c$$.hashTag="#team";$c$$.customData.seed="";$c$$.customData.mentions=
...
$sanitizeData$$($data$$22_viewData$$);$self$$.visitorScore.text($data$$22_viewData$$.visitingTeam.score);$self$$.homeScore.text($data$$22_viewData$$.homeTeam.score);$self$$.period.text($data$$22_viewData$$.game.period);$self$$.view.data($data$$22_viewData$$);$data$$22_viewData$$.game.status=="final"&&$self$$.view.addClass("game-final")};$self$$.setTeamModel=function setTeamModel($model$$){$self$$.teams=$model$$};(function init($data$$,$model$$){$self$$.id=$data$$.id;$self$$.teams=$model$$;$model$$.addEventListener("onTeamModelReady",
$onTeamUpdate$$);var $viewData$$=$sanitizeData$$($data$$);$self$$.view=$createView$$($viewData$$)})($gameData$$,$model$$0$$);return $self$$}NavController.prototype=new EventDispatcher;NavController.constructor=NavController;
